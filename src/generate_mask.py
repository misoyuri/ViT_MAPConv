...
class MaskGenerator(object):
    ...
    def _generate_mask(self):
        ...
        while True:
            ...
            # Set size scale
            size = int((self.width + self.height) * 0.05)
            ...
            if  224*224*0.95 > img[:,:,0].sum() > 224*224*0.65:
                break
        return img
...
if __name__ == '__main__':
    NUM_MASK = 200000
    DIR_NAME = 'val_mask'
    mask_generator = MaskGenerator(224, 224, channels=3,
                                   rand_seed=None, filepath=None)
    ...
    for idx in range(NUM_MASK):
        ...
        if idx < 190000:
            cv2.imwrite('/home/s20225004/FFHQ/train/mask_new2/{}.png'.format(str(idx).zfill(5)), mask)
        else:
            cv2.imwrite('/home/s20225004/FFHQ/val/mask_new2/{}.png'.format(str(idx).zfill(5)), mask)